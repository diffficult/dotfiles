...
Polymer({
      ...
      properties: {
        ...
        /**
         * Temporary strings for testing button layout.
         * @type {!Array<string>}
         */
        buttons: {
          type: Array,
...
Polymer({
      ...
      properties: {
        ...
        /**
         * The background color of the details section.
         * @type {string}
         */
...
Polymer({
      ...
      ready: function() {
        this.boundFocusListener_ = this.handleDocumentFocus_.bind(this);
      ...
      openedChanged_: function(opened) {
        if (opened) {
          document.addEventListener('focus', this.boundFocusListener_, true);
          ...
          document.removeEventListener('focus', this.boundFocusListener_, true);
      ...
      /**
       * Prevent focus from leaving the drawer.
       * @param {!FocusEvent} event
       * @private
       */
      handleDocumentFocus_: function(event) {
        var drawerContent = this.getDrawerContent_();
        var focusedInDrawer = drawerContent.contains(event.target);
        var firstFocusableNode = this.getFirstFocusableNode_();

        if (!focusedInDrawer && firstFocusableNode) {
