...
do
  ...
  local _base_0 = {
    ...
    update = function(self, mouseX, mouseY, mouseOver)
      local update = _class_0.__parent.__base.update(self, mouseX, mouseY, mouseOver)
...
do
  ...
  local _base_0 = {
    ...
    update = function(self, mouseX, mouseY, mouseOver)
      return _class_0.__parent.__base.update(self, mouseX, mouseY, mouseOver)
    end
  }
  _base_0.__index = _base_0
  setmetatable(_base_0, _parent_0.__base)
...
do
  ...
  local _base_0 = {
    ...
    update = function(self, mouseX, mouseY, mouseOver)
      return _class_0.__parent.__base.update(self, mouseX, mouseY, mouseOver, (self:containsPoint(mouseX, mouseY) or self.topBox:containsPoint(mouseX, mouseY)))
    end
  }
  _base_0.__index = _base_0
  setmetatable(_base_0, _parent_0.__base)
